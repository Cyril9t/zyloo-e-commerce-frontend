...
export default function LoginPage() {
    ...
    return (
        ...
        <div className="relative w-full h-screen grid lg:grid-cols-2 bg-[#f4f4f4] overflow-hidden">
            ...
            <div className="flex flex-col justify-between p-6 sm:p-10 lg:p-12 xl:p-16 bg-white/80 backdrop-blur-md lg:bg-white h-full overflow-y-auto">


                <div className="flex justify-between items-center lg:justify-end gap-6 text-xs text-neutral-500 tracking-wide">
                    <span className="lg:hidden font-bold text-xl text-black tracking-widest">ZYLOO</span>
                ...
                <div className="mx-auto w-full max-w-[400px] space-y-6 xl:space-y-8 my-auto py-4">
                    <div className="space-y-2 text-center lg:text-left">
                        ...
                        <p className="text-sm text-neutral-500 font-light">Sign in to your premium account</p>
                    </div>

                    <form className="space-y-4 xl:space-y-5">
                        <div className="space-y-2">
                            <Label htmlFor="email" className="text-xs font-medium uppercase tracking-wider text-neutral-600">
                                Email Address
                            </Label>
                            <Input
                                id="email"
                                ...
                                className="h-11 rounded-md border-neutral-200 focus-visible:ring-neutral-400 bg-neutral-50/50"
                            />
                        </div>

                        <div className="space-y-2">
                            <div className="flex justify-between items-center">
                                <Label htmlFor="password" className="text-xs font-medium uppercase tracking-wider text-neutral-600">
                                    Password
                                </Label>
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className="h-11 rounded-md border-neutral-200 pr-10 focus-visible:ring-neutral-400 bg-neutral-50/50"
                                />
                                <button
                                    type="button"
                    ...
                    <p className="text-center text-sm text-neutral-500 font-light">
                        New to ZYLOO?{" "}
                        <a href="/register" className="font-normal text-black underline underline-offset-4 hover:text-neutral-700">
                            Create an account
                        </a>
                    </p>
                </div>
