    ...
    return (
        ...
        <div>
            ...
            <div className="relative w-full h-screen grid lg:grid-cols-2  overflow-hidden ">
                ...
                <div className="flex flex-col justify-between p-5 sm:p-10 lg:p-12 xl:p-16 bg-(--color-background) backdrop-blur-md h-full overflow-y-auto scrollbar-none">
                    ...
                    <div className="mx-auto w-full max-w-[400px] space-y-4 xl:space-y-6 my-auto py-2">
                        ...
                        <div className="relative flex items-center py-1">
                            ...
                            <span className="absolute left-1/2 -translate-x-1/2  px-3  text-[10px] font-medium rounded uppercase tracking-widest bg-foreground text-card">
                        ...
                        <p className="text-center text-xs xl:text-sm text-foreground font-light">
                            Already have an account?{" "}
                            <a href="/login" className="font-normal text-foreground underline underline-offset-4 hover:text-neutral-700">
                                Sign In
                            </a>
                        </p>
                    </div>
