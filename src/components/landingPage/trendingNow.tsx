...
import { Eye, Heart, MoveRightIcon, ShoppingCart, TrendingUp, Zap } from 'lucide-react';

function TrendingNow() {
    const trendingNow = productList.filter(p => p.sections.includes("trending"))
        ...
        <div className="">
            ...
            <div className='mx-auto max-w-7xl'>
                ...
                <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    <div>
                        <p className='font-bold flex gap-4 mb-3'><TrendingUp />  Tending Now</p>
                ...
                <div className=" mb-20 flex gap-6 overflow-x-auto scroll-smooth scrollbar-none pb-4">
