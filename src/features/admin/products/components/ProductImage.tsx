...
export default function ProductImages({ uploaded, uploadProgress, setImages, images }: any) {
    ...
    const fileUpload = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        setImages((prev: any) => [...prev, ...preview]);
                ...
                {uploaded && (
                    <div className=" w-full ">
                        ...
                        <div className="flex items-center justify-between text-[11px] font-medium ">
                            <div className="flex items-center gap-2 text-sm"><ImageIcon className="h-3.5 w-3.5" /> <span>studio_blazer_hd_back.png</span></div>
                            <span className="font-mono text-sm">{uploadProgress}% Buffered</span>
                        </div>

                        <Progress value={uploadProgress} className="h-2 bg-foreground/20" />
