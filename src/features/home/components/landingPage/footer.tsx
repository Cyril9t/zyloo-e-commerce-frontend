...
export default function Footer() {
    ...
    return (
        <footer className="w-full border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 transition-colors duration-200">
            <div className="mx-auto max-w-7xl px-4 pt-6 pb-8 md:pt-12">

                {/* Main Content Grid */}
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-6 pb-12 border-b border-zinc-100 dark:border-zinc-900">
                    ...
                    <div className="md:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-6">
                        ...
                        <div className="col-span-2 sm:col-span-1 space-y-3">
                            ...
                            <div className="text-sm font-medium text-zinc-600 dark:text-zinc-400 space-y-2">
                ...
                {/* Bottom Metadata Bar */}
                <div className="pt-6 flex flex-col-reverse sm:flex-row items-center justify-between gap-3 text-xs font-medium text-zinc-500 dark:text-zinc-500">
